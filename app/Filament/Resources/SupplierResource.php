...
class SupplierResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('nama_perusahaan')->label("Perusahaan")->searchable(),
                Tables\Columns\TextColumn::make('nama_supplier')->label("Supplier")->searchable(),
                Tables\Columns\TextColumn::make('no_hp')->label("Contact")->searchable(),
